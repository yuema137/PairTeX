...
(async () => {
  ...
  if (!process.env.PAIRTEX_TEST_HTML) writeFileSync(html, '<p>Editable prose <span data-source-file="main.tex" data-editable="math" data-math-source="x"><span class="math-render"><math><mi>x</mi></math></span></span> after the formula.</p>');
